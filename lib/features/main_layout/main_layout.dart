...
import 'package:eCommerce_app/features/main_layout/categories/presentation/screens/categories_tab.dart';
...
import 'package:eCommerce_app/features/main_layout/home/presentation/screens/home_tab.dart';
import 'package:eCommerce_app/features/main_layout/profile_tab/presentation/screens/profile_tab.dart';
...
class _MainLayoutState extends State<MainLayout> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
      getIt<HomeBloc>()
        ..add(HomeGetCategoriesEvent())..add(HomeGetCartEvent())..add(HomeGetFavouriteEvent()),
