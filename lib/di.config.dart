...
import 'features/auth/domain/usecases/get_profile_use_case.dart' as _i723;
...
import 'features/products_screen/domain/usecases/get_favourite_use_case.dart'
    as _i1015;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i723.GetProfileUseCase>(
        () => _i723.GetProfileUseCase(gh<_i38.AuthRepo>()));
    ...
    gh.factory<_i759.FavouriteBloc>(
        () => _i759.FavouriteBloc(gh<_i1015.AddToFavouriteUseCase>()));
    return this;
  }
}
